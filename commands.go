...
// GetAllApps returns information about all apps.
func (tv *TV) GetAllApps() (Message, error) {
	msg, err := tv.Command(AppsListCommand, nil)
	return msg, err
}
...
// LaunchApp with contentId
func (tv *TV) LaunchAppWithContentId(app, contentId string) error {
